window.TILE_VERSION = {
    "ditu": {
        "normal": {"version": "088", "updateDate": "20230105"},
        "satellite": {"version": "009", "updateDate": "20230105"},
        "normalTraffic": {"version": "081", "updateDate": "20230105"},
        "satelliteTraffic": {"version": "083", "updateDate": "20230105"},
        "mapJS": {"version": "104", "updateDate": "20230105"},
        "satelliteStreet": {"version": "083", "updateDate": "20230105"},
        "earthVector": {"version": "001", "updateDate": "20230105"}
    },
    "webapp": {
        "high_normal": {"version": "001", "updateDate": "20230105"},
        "lower_normal": {"version": "002", "updateDate": "20230105"}
    },
    "api_for_mobile": {
        "vector": {"version": "002", "updateDate": "20230105"},
        "vectorIcon": {"version": "002", "updateDate": "20230105"}
    }
};
window.BMAP_AUTHENTIC_KEY = "";
(function () {
    var b2, a8 = b2 = a8 || {version: "1.3.4"};
    a8.guid = "$BAIDU$";
    ...
    a8.dom.getStyle = function (cM, cL) {
        ...
        var cO = cM.style[cL];
        if (!cO) {
            var T = cP._styleFixer[cL], cN = cM.currentStyle || (a8.browser.ie ? cM.style : getComputedStyle(cM, null));
    ...
    a8.dom.getPosition = function (T) {
        T = a8.dom.g(T);
        var cT = a8.dom.getDocument(T), cN = a8.browser, cQ = a8.dom.getStyle,
            cM = cN.isGecko > 0 && cT.getBoxObjectFor && cQ(T, "position") == "absolute" && (T.style.top === "" || T.style.left === ""),
            cR = {left: 0, top: 0}, cP = (cN.ie && !cN.isStrict) ? cT.body : cT.documentElement, cU, cL;
        if (T == cP) {
            return cR
        }
        if (T.getBoundingClientRect) {
            ...
            var cS = cT.body, cV = parseInt(cQ(cS, "borderLeftWidth")), cO = parseInt(cQ(cS, "borderTopWidth"));
    ...
    a8.extend(bz.prototype, {
        render: function () {
            ...
            cM.zIndex = "1200";
            cM.top = cM.left = "0px";
            cM.margin = "24px 120px auto 120px";
            cM.padding = "12px";
            cM.background = "rgba(255,0,0,0.8)";
            cM.userSelect = "none";
            var cO = aa("span", {style: "position:absolute;\n    top: -6px;\n    right: -6px;\n    padding: 1px;\n    font-size: 12px;\n    display: block;\n    cursor: pointer;\n    background: rgb(245 243 239);\n    border: solid 1px #3f51b53b;\n    color: #060606;\n    border-radius: 3px;"});
            cO.innerText = "\u5173\u95ed";
            ...
            var cL = aa("a", {
                ...
                "class": "BMap_cpyCtrl",
                style: "text-decoration: none;outline: none;cursor:pointer;"
            });
            var cN = aa("div");
            var cP = cN.style;
            ...
            cP.width = "100%";
            cP.height = "100%";
            cP.color = "rgb(251 243 243)";
            cP.fontSize = "14px";
            cP.wordBreak = "break-all";
            cN.innerHTML = "\u60a8\u6240\u4f7f\u7528\u7684\u5730\u56feJS API\u7248\u672c\u8fc7\u4f4e\uff0c\u5df2\u4e0d\u518d\u7ef4\u62a4\uff0c\u4e3a\u4fdd\u8bc1\u5730\u56fe\u57fa\u672c\u529f\u80fd\u6b63\u5e38\u4f7f\u7528\uff0c\u8bf7\u5c3d\u5feb\u5347\u7ea7\u5230<a target='_blank' href='https://lbsyun.baidu.com/index.php?title=jspopularGL' style='outline: none;cursor:pointer;'>\u6700\u65b0\u7248\u5730\u56feJS API</a>\u3002";
            T.appendChild(cO);
            T.appendChild(cN);
            return T
            ...
            var cL = arguments[0] || {}, cN = cL.margins || [0, 0, 0, 0], T = cL.zoom || null,
                cO = this.pixelToPoint({x: cN[3], y: this.height - cN[2]}, T),
                cM = this.pixelToPoint({x: this.width - cN[1], y: cN[0]}, T);
            return new bN(cO, cM)
        }, isLoaded: function () {
            return !!this.loaded
        }, _getBestLevel: function (cL, cM) {
            var cP = this.getMapType();
            var cR = cM.margins || [10, 10, 10, 10], cO = cM.zoomFactor || 0, cS = cR[1] + cR[3], cQ = cR[0] + cR[2],
                T = cP.getMinZoom(), cU = cP.getMaxZoom();
            ...
            var cX = {center: this.getCenter(), zoom: this.getZoom()};
            ...
            if (T.zoom == this.zoomLevel && cO.enableAnimation != false) {
                var cN = this;
                setTimeout(function () {
                    cN.panTo(T.center, {duration: 210})
                }, cM)
            } else {
    ...
    window._addStat = function (cP, cO) {
        ...
        if (_addStat._sending) {
            _addStat._reqQueue.push({src: "t=" + cM + "&code=" + cP + cN})
        } else {
            cQ({src: "t=" + cM + "&code=" + cP + cN})
        }
        if (!_addStat._binded) {
    ...
    _addStat(5000, {v: BMap.version});

    function g(cN) {
        var T = {
            duration: 1000, fps: 30, delay: 0, transition: aw.linear, onStop: function () {
            }
        };
        this._anis = [];
        if (cN) {
    ...
    var cx = {
        request: function (cL) {
            cL += "&v=1.3";
            var T = aa("script", {src: cL, type: "text/javascript", charset: "utf-8"});
    ...
    a8.object.extend(cA, {
        ...
        preLoaded: {},
        Config: {_baseUrl: w + "getmodules?v=1.3", _timeout: 5000},
        delayFlag: false,
    ...
    function bK(T) {
        ...
        T = T || {};
        this._opts = {printable: false};
        this._opts = a8.object.extend(a8.object.extend(this._opts, {color: "black", unit: "metric"}), T);
        this.defaultAnchor = BMAP_ANCHOR_BOTTOM_LEFT;
    ...
    function aL(T) {
        ...
        this.defaultOffset = new aH(10, 10);
        this.setAnchor(T.anchor);
        this._opts = a8.extend(a8.extend(this._opts, {offset: this.defaultOffset, enableSwitch: true}), T);
        if (aY(T.mapTypes)) {
    ...
    a8.extend(b6, {
        num: {
            ...
            return {j: cW, w: cU, x: 100000 / cW, y: 100000 / cU}
            ...
            return {x: Math.floor(cM.x), y: 9998336 - Math.floor(cM.y), lt: cL.lt, rb: cL.rb}
            ...
            return {lng: T.lng, lat: T.lat, lt: cN.lt, rb: cN.rb}
        }
    });
    ...
    function L(cL, cM, cN) {
        ...
        var cO = {anchor: T, imageOffset: new aH(0, 0)};
        cN = cN || {};
        a8.extend(cO, cN);
    ...
    bz.prototype.openInfoWindow = function (cN, T) {
        ...
        var cL = this.temp;
        if (!cL.marker) {
            var cM = new L(cc.imgPath + "blank.gif", {width: 1, height: 1});
            cL.marker = new ad(T, {
                icon: cM,
                width: 1,
                height: 1,
    ...
    a8.extend(a.prototype, {
        initialize: function (T) {
            ...
            var cZ = [];
            var cU = cS / 6378800, cR = (Math.PI / 180) * cN, cX = (Math.PI / 180) * cP;
    ...
    function bU(cR, T, cO, cL, cN) {
        ...
        this.img.onload = function (cY) {
            ...
            if (D) {
                new g({
                    fps: 20, duration: 200, render: function (cZ) {
    ...
    aC.prototype.getTilesUrl = function (cQ, cL) {
        ...
        var cM = this._map, cS = cQ.x, cN = cQ.y, cP = Math.floor(cS / 200), cO = Math.floor(cN / 200),
    ...
    var i = ["http://maponline0.bdimg.com/tile/", "http://maponline1.bdimg.com/tile/", "http://maponline2.bdimg.com/tile/", "http://maponline3.bdimg.com/tile/"];
    var N = {
    ...
    if (l) {
        b7 = [w + "it/"];
        i = ["https://" + N.TILE_ONLINE_URLS[0] + "/tile/", "https://" + N.TILE_ONLINE_URLS[1] + "/tile/", "https://" + N.TILE_ONLINE_URLS[2] + "/tile/", "https://" + N.TILE_ONLINE_URLS[3] + "/tile/",]
    }
    var aT = new o();
    aT.getTilesUrl = function (cM, cP) {
        ...
        var cL = i[Math.abs(cQ + cN) % i.length] + "?qt=vtile&x=" + (cQ + "").replace(/-/gi, "M") + "&y=" + (cN + "").replace(/-/gi, "M") + "&z=" + cP + "&styles=" + cO + (a8.browser.ie == 6 ? "&color_dep=32&colors=50" : "") + "&udt=" + T;
        return cL.replace(/-(\d+)/gi, "M$1")
    };
    window.BMAP_NORMAL_MAP = new cu("\u5730\u56fe", aT, {tips: "\u663e\u793a\u666e\u901a\u5730\u56fe"});
    var bs = new o();
    ...
    var n = new o({transparentPng: true});
    ...
    var bb = {
        REQ_BASE_URL: w, request: function (cQ, cN, cL, cS, cM) {
            ...
            var cP = this, T = cP.REQ_BASE_URL + cS + "?" + cR + "&ie=utf-8&oue=1&fromproduct=jsapi&v=1.3";
            if (!cM) {
                T += "&res=api"
            }
    ...
    a8.extend(a4.prototype, {
        search: function (T) {
            ...
            this._queryList.push({method: "searchInBounds", arguments: [T, cL]})
        }, searchNearby: function (cM, cL, T) {
            this._queryList.push({method: "searchNearby", arguments: [cM, cL, T]})
    ...
    a8.extend(aU.prototype, {
        setPolicy: function (T) {
            ...
            this._queryList.push({method: "_internalSearch", arguments: [cL, T]})
        }, search: function (cL, T) {
            this._queryList.push({method: "search", arguments: [cL, T]})
        }, setPageCapacity: function (T) {
            if (typeof T == "string") {
                T = parseInt(T);
                if (isNaN(T)) {
    ...
    a8.extend(aX.prototype, {
        getPoint: function (T, cM, cL) {
            this._queryList.push({method: "getPoint", arguments: [T, cM, cL]})
        }, getLocation: function (T, cM, cL) {
            this._queryList.push({method: "getLocation", arguments: [T, cM, cL]})
        }, toString: function () {
            return "Geocoder"
        }
    });
    ...
    a8.extend(ak.prototype, {
        getCurrentPosition: function (cL, T) {
            this._queryList.push({method: "getCurrentPosition", arguments: [cL, T]})
        }, getStatus: function () {
            return this._status
        }
    });
    ...
    a8.extend(V.prototype, {
        get: function (cL, T) {
            this._queryList.push({method: "get", arguments: [cL, T]})
        }, toString: function () {
            return "Boundary"
        }
    });
