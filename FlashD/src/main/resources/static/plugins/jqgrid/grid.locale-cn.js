...
$.jgrid.regional["cn"] = {
    defaults : {
        recordtext: "{0} - {1}\u3000共 {2} 条", // 共字前is全角空格
        emptyrecords: "nodata view",
        loadtext: "read中...",
		savetext: "Saving...",
        pgtext : " {0} 共 {1} 页",
		pgfirst : "First Page",
    ...
    search : {
        ...
        groupOps: [ { op: "AND", text: "all" },    { op: "OR",  text: "任一" } ],
    ...
    edit : {
        ...
        editCaption: "编辑记录",
        bSubmit: "提交",
        bCancel: "cancellation",
        bClose: "close",
        saveData: "data已改变，isnosave？",
        bYes : "is",
        bNo : "no",
        bExit : "cancellation",
        msg: {
            ...
            minValue:"输值必须大于等于 ",
            maxValue:"输值必须小于等于 ",
            email: "这不is有效的e-mailaddress",
            integer: "Enter有效整数",
            date: "Enter有效时间",
            url: "no效网址。前缀必须为 ('http://' 或 'https://')",
            nodefined : " 未定义！",
            novalue : " 需要return值！",
            customarray : "自定义函数需要return数组！",
    ...
    nav : {
        ...
        searchtitle: "查找",
        refreshtext: "",
        refreshtitle: "刷新 table格",
        alertcap: "注意",
        alerttext: "Please select记录",
        viewtext: "",
        viewtitle: "查看所选记录",
		savetext: "",
		savetitle: "Save row",
